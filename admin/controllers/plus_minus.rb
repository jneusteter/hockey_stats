HockeyStatsTracker::Admin.controllers :plus_minus do
  ...
  get :edit, with: :id do
    ...
    if @plus_minus
      ...
      flash[:warning] = pat(:create_error, model: 'plus_minus', id: params[:id].to_s)
      halt 404
    end
  end
  ...
  put :update, with: :id do
    ...
    if @plus_minus
      if @plus_minus.modified! && @plus_minus.update(params[:plus_minus])
        flash[:success] = pat(:update_success, model: 'Plus_minus', id: params[:id].to_s)
      ...
      flash[:warning] = pat(:update_warning, model: 'plus_minus', id: params[:id].to_s)
      halt 404
    end
  end
  ...
  delete :destroy, with: :id do
    ...
    if plus_minus
      if plus_minus.destroy
        flash[:success] = pat(:delete_success, model: 'Plus_minus', id: params[:id].to_s)
      else
        flash[:error] = pat(:delete_error, model: 'plus_minus')
      end
      redirect url(:plus_minus, :index)
    else
      flash[:warning] = pat(:delete_warning, model: 'plus_minus', id: params[:id].to_s)
      halt 404
    end
  end
  ...
  delete :destroy_many do
    ...
    if plus_minus.destroy
      ...
      flash[:success] = pat(:destroy_many_success, model: 'Plus_minus', ids: ids.join(', ').to_s)
    end
    redirect url(:plus_minus, :index)
  end
end
